  ...
  $headlines.each(function () {
    ...
    if (headline.hasClass('loading-bar')) {
      ...
      const spanWrapper = headline.find('.cd-words-wrapper'),
        newWidth = (spanWrapper.width() || 0) + 10
...
function hideWord($word: JQuery<HTMLElement>) {
  ...
  if ($word.parents('.cd-headline').hasClass('type')) {
    ...
    const bool =
      $word.children('i').length >= nextWord.children('i').length ? true : false
...
function showWord($word: JQuery<HTMLElement>, $duration: number | undefined) {
  if ($word.parents('.cd-headline').hasClass('type')) {
...
function hideLetter(
  $letter: JQuery<HTMLElement>,
  $word: JQuery<HTMLElement>,
  $bool: boolean,
    ...
    <section className="cd-intro">
      <h1 className="cd-headline slide">
        ...
        <span className="cd-words-wrapper">
          <b className="is-visible">Food & Beverage</b>
          <b>Otomotif</b>
          <b>Kecantikan</b>
          <b>Kesehatan</b>
          <b>Properti</b>
